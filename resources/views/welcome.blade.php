<x-guest-layout>
        ...
        <h1
          ...
          <span class="inline md:block">Bienvenido al restaurante "FOGON VERDE"</span>
        </h1>
        <div class="mx-auto mt-2 text-green-50 md:text-center lg:text-lg">
          {{-- aqui podriamos poner algo de texto pero por el momento no  --}}
        </div>
          ...
          <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="w-full md:w-1/2 md:px-3">
              ...
              > -->
                ...
                <h2 class="text-4xl text-green-600">Bienvenido</h2>
                <!-- </h1> -->
                <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  El Fogón Verde es mucho más que un restaurante es un santuario gastronómico. Situado en un pintoresco rincón, nuestro restaurante se distingue por ofrecer una experiencia culinaria única, centrada en ingredientes frescos y orgánicos. Nuestro compromiso con la calidad se refleja en cada plato, donde la creatividad se une a sabores auténticos para deleitar los sentidos de nuestros comensales. Con un ambiente acogedor en Fogón Verde, cada visita es un viaje culinario que celebra la excelencia gastronómica.
                </p>
          ...
          <div class="flex flex-wrap items-center -mx-3">
            <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
              <div class="w-full lg:max-w-md">
                ...
                <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">Destacamos por nuestro compromiso con la sostenibilidad, ofreciendo una cocina creativa con ingredientes orgánicos locales. Nuestro ambiente acogedor y atención centrada en el bienestar garantizan una experiencia culinaria única.</p>
                <ul>
                  <li class="flex items-center py-2 space-x-4 xl:py-3">
                    ...
                    <span class="font-medium text-gray-500">Rapida entrega</span>
                  </li>
                  <li class="flex items-center py-2 space-x-4 xl:py-3">
                    ...
                    <span class="font-medium text-gray-500">pagos rapidos</span>
                  </li>
                  <li class="flex items-center py-2 space-x-4 xl:py-3">
                    <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="font-medium text-gray-500">100% Seguro</span>
                  </li>
                </ul>
              </div>
            </div>
