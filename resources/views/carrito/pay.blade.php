    ...
    <div class="m-4">
      <div class="credit-card w-full sm:w-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
        ...
        <footer class="mt-6 p-4">
          <button
            class="submit-button px-4 py-3 rounded-full bg-green-500 text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors"
    ...
    <script>
      document.addEventListener("alpine:init", () => {
        Alpine.data("creditCard", () => ({
          ...
          onSubmit() {
            alert(`Seguro quieres pagar? ${this.cardholder}.`);
          },
          cardholder: '',
          cardNumber: '',
          expired: {
